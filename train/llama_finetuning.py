...
def main(**kwargs):
    ...
    if fsdp_config.pure_bf16 and fsdp_config.optimizer == "anyprecision":
        ...
        optimizer = optim.AdamW(
            ...
            lr=train_config.lr,
            weight_decay=0.0,
            # weight_decay=train_config.weight_decay,#0.0,
        )
    if train_config.scheduler == "step":
        ...
        scheduler = get_cosine_schedule_with_warmup(
            optimizer=optimizer,
            num_warmup_steps=math.ceil(num_training_steps*0.03),
            num_training_steps=num_training_steps,
        )
    else:
        raise ValueError(f"undefined scheduler: {train_config.scheduler}")
